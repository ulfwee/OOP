...
{
    public class Theater : IComparable<Theater>
    {
        ...
        public void SetSchedule(TimeSpan start, int duration)
        {
            Schedule = new Schedule(start, duration); 
        }
        ...
        {
           return $"{Name} ({Genre}) — {Date:dd.MM.yyyy}, Розклад: {Schedule}";
